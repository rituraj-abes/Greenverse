...
//  xTaskCreate(WifiManagerTask, "WifiManager Task", 10000, NULL, 1, &WifiManagerTaskHandle);
  xTaskCreate(AWSTask, "AWS Task", 8000, NULL, 1, &AWSTaskHandle);
